defmodule RailwayIpc.StreamBehaviour do
  ...
  @callback connect(connection_url :: String.t) :: {:ok, %{connection: map(), channel: map()}} | {:error, any()}
  ...
  @callback create_queue(channel :: map(), queue_name :: String.t, opts :: list()) :: {:ok, map()}
